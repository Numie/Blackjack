...
import { basicStrategy } from './basic_strategy';
...
export default class Game {
  ...
  addToCount(card) {
    ...
    const self = this
    // console.log(self.dealer.hand.cards.length)
    if (this.dealer.hand.cards.length === 2 && this.player.currentHand && !this.player.currentHand.busted && !this.player.currentHand.isDoubled && !this.player.currentHand.isBlackjack && !this.dealer.hand.isBlackjack) console.log(basicStrategy(self));
  }
