...
export const chipsSound = new Audio('sounds/chips.mov');
export const swooshSound = new Audio('sounds/swoosh.mp3');
export const winnerSound = new Audio('sounds/clapping.mp3');
export const loseSound = new Audio('sounds/loseSound.mp3');
