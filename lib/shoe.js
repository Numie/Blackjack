...
export default class Shoe {
  ...
  shuffle() {
    ...
    // const twoCard = new Card('2', 's');
    // const card1 = Object.assign(new Card, twoCard);
    // const card2 = Object.assign(new Card, twoCard);
    // const card3 = Object.assign(new Card, twoCard);
    // this.cards.splice(0, 0, twoCard);
    // this.cards.splice(2, 0, twoCard);
    // this.cards.splice(4, 0, twoCard);
